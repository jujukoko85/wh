...
document.write("#calendarTable td{width:21px;height:20px;border-bottom:1px solid #E6E6E6;color:#fff;background:#fff;}");
document.write("#calendarTable th{height:21px;background:#fff;}");
...
function setday(obj){objInput = obj;writeDate();showdate();objouter.style.top =getAbsoluteHeight(objInput)+getAbsoluteTop(objInput);objouter.style.left =getAbsoluteLeft(objInput);objouter.style.display = "block";}
...
var sohwId = document.getElementById("showdate");
...
function getDate(day){
    ...
    objInput.value = year + "-" + month +"-"+ date+" "+  h  +":"+ m +":"+ s;
    close();
}
function showdate(){
