...
(function( $ ) {
    ...
    $.extend(Wysiwyg, {
        ...
        TOOLBAR : {
            ...
            separator08 : { separator : true && !( isIE ) },

            increaseFontSize : { visible : true && !( isIE ), tags : ['big'] },
            decreaseFontSize : { visible : true && !( isIE ), tags : ['small'] },
    ...
    $.extend(Wysiwyg.prototype,
    {
        ...
        initFrame : function()
        {
            ...
            $(this.editorDoc).keydown(function( event ) {
                if ( isIE && self.options.brIE && event.keyCode == 13 ) {
